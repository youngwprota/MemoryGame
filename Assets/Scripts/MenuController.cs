...
public class MenuController : MonoBehaviour
{
    ...
    public static void ClearAllHighScores()
    {
		...
		ClearAllHighScoreTextObjects();
    }

    private static void ClearAllHighScoreTextObjects()
    {
        GameObject[] scoreTextObjects = GameObject.FindGameObjectsWithTag("HighScoreText");

        foreach (GameObject textObject in scoreTextObjects)
        {
